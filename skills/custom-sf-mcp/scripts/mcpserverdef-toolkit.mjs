...
// this script's shipped location (.claude/skills/custom-sf-mcp/scripts/), which needs 4
// directory levels up (scripts -> custom-sf-mcp -> skills -> .claude -> repo root), not 2 -
...
// (where force-app/ lives) needs 4 levels up (scripts -> custom-sf-mcp -> skills -> .claude
